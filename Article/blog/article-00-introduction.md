...
本書サブセットでは論文全32ファイルのうち9患者分（18ファイル）を扱い、sage で同定した **2,260 タンパク質**、有意差 **1,015 個**、COSMIC 主要ドライバー（KRAS, CTNNB1, PIK3CA 等）**21個** を検出しました。
...
| #5 | 前処理 | Log2変換・欠損値補完 |
| #6 | 全体像の可視化 | 相関行列・クラスタリング・PCA |
| #7 | 差分発現解析 | Welch's t-test・Volcanoプロット |
| #8 | COSMIC照合 | がん関連タンパク質の同定 |
| #9 | ステージ別解析 | ANOVA・クラスター分析 |
| #10 | まとめと次のステップ | 論文化への道筋 |
